...
//     void shutdown_both(std::shared_ptr<boost::asio::ip::tcp::socket> a, std::shared_ptr<boost::asio::ip::tcp::socket> b);
...
{
public:
    SmppProxy(IOContextPool& io_pool, const std::vector<std::string>& upstream_hosts, int upstream_port);
